...
<script type="text/javascript" src="./js/extjs/ext-all-6.0.2.js">
...
<script type="text/javascript" src="./js/js/EmpList.js">
...
rel = "stylesheet" />
 ...
 <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/extjs/6.2.0/classic/theme-triton/resources/theme-triton-all-debug.css"></link>
